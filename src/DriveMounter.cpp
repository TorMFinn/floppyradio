#include "floppyradio/DriveMounter.hpp"
...
DriveMounter::~DriveMounter() = default;

void DriveMounter::automount_device(const std::string &drive_serial) {
}

void DriveMounter::set_drive_mounted_callback(drive_mounted_callback callback) {
    impl_->mounted_callback = callback;
}

void DriveMounter::set_drive_unmounted_callback(drive_unmounted_callback callback) {
